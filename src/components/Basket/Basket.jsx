    ...
    return (
      <div className={styles.container}>
        ...
        {opened &&
          (localStorageItems === 0 ? (
            <div>
              <div className={styles.cartButton} style={{ textAlign: 'end' }} onClick={() => setOpened(false)}><img src='./exit.png' style={{ width: '40%' }} alt="img" /></div>
            </div>
          ) : (
            <>
              <div className={styles.cartButton} style={{ textAlign: 'end' }} onClick={() => setOpened(false)}><img src='./exit.png' style={{ width: '40%' }} alt="img" /></div>
              ...
              <button onClick={handleSendCart} className={styles.total}>Оформить доставку</button>
            </>
          ))}
      </div>
    )
